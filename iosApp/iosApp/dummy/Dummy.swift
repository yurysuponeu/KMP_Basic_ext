...
struct UserProfile: IdentifiableItem, Nameable, Serializable {
    let id: UUID
    var name: String
    var email: String?
    var role: UserRole
    ...
    static func fromJson(data: Data) -> UserProfile? {
...
// MARK: - Inheritance Example

class SpecialUserProfile: UserProfile {
    var specialBadge: String?

    init(id: UUID, name: String, email: String?, role: UserRole, badge: String?) {
        self.specialBadge = badge
        super.init(id: id, name: name, email: email, role: role, lastLogin: nil, preferences: [:])
    }

    // Override method
    override func hasAdminPrivileges() -> Bool {
        if specialBadge == "super_admin" {
            return true
        }
        // Call superclass implementation
        return super.hasAdminPrivileges()
    }

    // Override computed property (Not possible directly for stored properties like 'name',
    // but can override methods accessing them or add new computed ones)
    var detailedDescription: String {
        return "\(super.description) - Badge: \(specialBadge ?? "None")"
    }

    // Convenience initializer
    convenience init(name: String, role: UserRole = .guest) {
        self.init(id: UUID(), name: name, email: nil, role: role, badge: nil)
    }
}
...
func runBenchmarkOperations() {
    ...
    if let json = user.toJson() {
        print("User JSON: \(json.prefix(100))...")
    }
...
// ... add more similar dummy lines if strictly needed to reach 1000 ...
// line 950
// line 951
// line 952 // Simple comment
// line 953
...
// line 958
// line 959
// line 960 - More padding
func paddingFunc1() { print("Pad 1") }
// line 962
func paddingFunc2() { print("Pad 2") }
// line 964
// line 965 /* Another comment style */
// line 966
// line 967
// line 968
// line 969
// line 970 Struct definition
...
// line 995
// line 996
// line 997 // Nearly there
// line 998
// line 999
// line 1000 - End of file marker comment.
